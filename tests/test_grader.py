...
def run_grader(engine_dir: str) -> dict:
    ...
    if not is_clean:
        return {"tier1_framing": 0.0, "tier2_mpmc": 0.0, "tier3_reassembly": 0.0, "tier4_matrix": 0.0, "matrix_passed": 0, "matrix_total": 3300, "score": 0.0, "error": msg}
    ...
    try:
        ...
        return {"tier1_framing": 0.0, "tier2_mpmc": 0.0, "tier3_reassembly": 0.0, "tier4_matrix": 0.0, "matrix_passed": 0, "matrix_total": 3300, "score": 0.0, "error": str(e)}
    ...
    print(f"  [TIER 4] 3,300-State Matrix Stress  : {t4:.3f} / 0.250 ({m_passed}/3300 passed)")
